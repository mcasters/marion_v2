...
export const drawingCategoryRelations = relations(drawingCategory, ({one, many}) => ({
...
export const categoryContentRelations = relations(categoryContent, ({many}) => ({
...
export const paintingCategoryRelations = relations(paintingCategory, ({one, many}) => ({
...
export const sculptureCategoryRelations = relations(sculptureCategory, ({one, many}) => ({
